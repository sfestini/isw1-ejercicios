...
class brazoExcavador{
	public:
		...
		int excavar(bool tipoSuelo);	// 0 = suelo blando - 1 = suelo duro // 0 excavacion exitosa, cualquier otra cosa ERROR
